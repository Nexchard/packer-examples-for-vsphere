...
source "vsphere-iso" "linux-rocky" {
  ...
  boot_command = [
    ...
    "text text net.ifnames=0 biosdevname=0 ip=172.17.124.192::172.17.124.1:255.255.255.0:template:eth0:none nameserver=114.114.114.114 ${local.data_source_command}",
